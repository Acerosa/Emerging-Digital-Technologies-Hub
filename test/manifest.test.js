...
test("hub config matches the canonical manifest", function () {
  ...
  assert.equal(manifest.compatibility.required.coreVersion, "0.2.10");
  ...
  assert.equal(provenance.coreVersion, "0.2.10");
  ...
  assert.equal(provenance.packages.core.tag, "v0.2.10");
});
