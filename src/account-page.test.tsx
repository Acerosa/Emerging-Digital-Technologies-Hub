...
describe("L2E canonical account page", () => {
  it("opens Core sign-in and create-account without a hub-owned signup form", () => {
    ...
    expect(screen.getByText(/Joining your L2E class is a separate step/i)).toBeTruthy();
  ...
  it("does not render Refresh session when no platform is supplied", () => {
    render(<AccountPage platformState="signed-out" onSignIn={vi.fn()} />);
