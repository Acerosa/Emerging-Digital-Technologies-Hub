/** Enrolment / join-class helpers for the L2E Exploring Emerging Digital Technologies hub. */

export const SIGN_IN_TO_CONTINUE = "Sign in to continue.";
export const JOIN_CLASS_MESSAGE =
  "You need to join your L2E class before this activity can be checked.";
export const JOIN_CLASS_PROMPT = "Join your class to continue";
export const EXPECTED_REGISTRATION_KEY = "nhc-et-26";
export const EXPECTED_GROUP_CODE = "L2E-DELIVERY-A";
export const ACCEPTED_GROUP_CODES = Object.freeze([EXPECTED_GROUP_CODE]);
...
export function isAcceptedL2eGroupCode(groupCode: string | null | undefined): boolean {
 ...
 * Other-course enrolments (e.g. Cyber or T Level) must not unlock L2E marking.
 */
export function hasExpectedGroupEnrolment(
  ...
  return enrolments.some((row) => {
    ...
    return expected ? code === expected : isAcceptedL2eGroupCode(code);
  });
}
...
export function isL2eRegistrationOption(option: RegistrationOption): boolean {
